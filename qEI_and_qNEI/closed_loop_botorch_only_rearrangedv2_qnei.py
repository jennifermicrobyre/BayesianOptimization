...
def inputs():
    ...
    N_BATCH = 2 if not SMOKE_TEST else 2
...
def plot(synthetic_test_function, N_BATCH, BATCH_SIZE, N_TRIALS, best_observed_all_nei):
...
def main():
    ...
    for trial in range(1, N_TRIALS + 1):
        ...
        for iteration in range(1, N_BATCH + 1):
            ...
            if verbose:
                print(
                    f"\nBatch {iteration:>2}: best_value (qNEI) = "
        ...
        plot(synthetic_test_function, N_BATCH, BATCH_SIZE, N_TRIALS, best_observed_all_nei)
