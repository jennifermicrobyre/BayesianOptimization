...
BATCH_SIZE = 5 if not SMOKE_TEST else 2
...
def plot(N_BATCH, BATCH_SIZE, best_observed_all_ei, best_observed_all_nei, best_random_all):
...
plot(N_BATCH, BATCH_SIZE, best_observed_all_ei, best_observed_all_nei, best_random_all)